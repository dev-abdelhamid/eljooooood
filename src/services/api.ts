...
export const factoryInventoryAPI = {
  getAll: async (params: { product?: string; department?: string; lowStock?: boolean; stockStatus?: 'low' | 'normal' | 'high'; lang?: string } = {}) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryInventoryAPI.getAll - Error:`, error);
      throw error;
    }
  },
  ...
  create: async (data: { productId: string; userId: string; currentStock: number; minStockLevel?: number; maxStockLevel?: number; orderId?: string }) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryInventoryAPI.create - Error:`, error);
      throw error;
    }
  },
  ...
  bulkCreate: async (data: { userId: string; orderId?: string; items: { productId: string; currentStock: number; minStockLevel?: number; maxStockLevel?: number }[] }) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryInventoryAPI.bulkCreate - Error:`, error);
      throw error;
    }
  },
  ...
  updateStock: async (id: string, data: { currentStock?: number; minStockLevel?: number; maxStockLevel?: number }) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryInventoryAPI.updateStock - Error:`, error);
      throw error;
    }
  },
  ...
  getHistory: async (params: { productId?: string; department?: string; period?: 'daily' | 'weekly' | 'monthly'; lang?: string } = {}) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryInventoryAPI.getHistory - Error:`, error);
      throw error;
    }
  },
  ...
  getAvailableProducts: async () => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryInventoryAPI.getAvailableProducts - Error:`, error);
      throw error;
    }
  },
};
...
export const factoryOrdersAPI = {
  create: async (data: { orderNumber: string; items: { product: string; quantity: number; price: number }[]; notes?: string; priority?: string }) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryOrdersAPI.create - Error:`, error);
      throw error;
    }
  },
  ...
  getAll: async () => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryOrdersAPI.getAll - Error:`, error);
      throw error;
    }
  },
  ...
  getById: async (id: string) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryOrdersAPI.getById - Error:`, error);
      throw error;
    }
  },
  ...
  assignChefs: async (id: string, data: { items: { itemId: string; assignedTo: string }[] }) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryOrdersAPI.assignChefs - Error:`, error);
      throw error;
    }
  },
  ...
  updateStatus: async (id: string, data: { status: 'pending' | 'in_production' | 'completed' | 'cancelled' }) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryOrdersAPI.updateStatus - Error:`, error);
      throw error;
    }
  },
  ...
  confirmProduction: async (id: string) => {
    try {
      ...
      console.error(`[${new Date().toISOString()}] factoryOrdersAPI.confirmProduction - Error:`, error);
      throw error;
    }
  },
};

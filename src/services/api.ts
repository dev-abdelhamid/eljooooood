...
export const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://eljoodia-server-production.up.railway.app/api';
...
export { notificationsAPI, returnsAPI, salesAPI, inventoryAPI };
export default api;

      ...
      {(isOpen || isLargeScreen) && (
        <>
          ...
          <motion.aside
            ...
            className={`fixed top-16  bottom-0 flex flex-col z-50 bg-gradient-to-b from-amber-50 to-amber-100/70  backdrop-blur-3xl shadow-md overflow-y-auto overflow-x-hidden ${

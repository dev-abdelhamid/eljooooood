...
const translations = {
  ar: {
    ...
    errors: {
      ...
      invalid_dates: 'تاريخ البدء يجب أن يكون قبل تاريخ النهاية',
...
const SalesAnalytics: React.FC = () => {
  ...
  const fetchBranches = useCallback(async () => {
    try {
      ...
      console.log(`[${new Date().toISOString()}] fetchBranches - Response:`, response);
      ...
      console.error(`[${new Date().toISOString()}] fetchBranches - Error:`, { message: err.message, status: err.status, stack: err.stack });
  ...
  const fetchDepartments = useCallback(async () => {
    try {
      ...
      console.log(`[${new Date().toISOString()}] fetchDepartments - Response:`, response);
      ...
      console.error(`[${new Date().toISOString()}] fetchDepartments - Error:`, { message: err.message, status: err.status, stack: err.stack });
  ...
  const fetchAnalytics = useCallback(async () => {
    ...
    try {
      ...
      console.log(`[${new Date().toISOString()}] fetchAnalytics - Sending:`, params);
      const response = await salesAPI.getAnalytics(params);
      console.log(`[${new Date().toISOString()}] fetchAnalytics - Response:`, response);
      ...
      console.error(`[${new Date().toISOString()}] fetchAnalytics - Error:`, { message: err.message, status: err.status, stack: err.stack });
      const errorMessage =

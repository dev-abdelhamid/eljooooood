...
export const ProductSearchInput: React.FC<{
  ...
  return (
    <div className={`relative px-3 py-1.5   group w-full ${className} ` }>
      <motion.div
      ...
      <input
        ...
        className={`w-full ${isRtl ? 'pl-12 pr-4' : 'pr-12 pl-4'}   border border-gray-200 rounded-lg focus:ring focus:ring-amber-500 focus:border-transparent transition-all duration-300 bg-white shadow-sm hover:shadow-md text-sm placeholder-gray-400 ${isRtl ? 'text-right' : 'text-left'}`}
  ...
  return (
    <div className={`min-h-screen px-4 py-8 `}>
      <div className="mb-6 bg-white shadow-md rounded-xl p-4 border border-gray-200">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 align-center items-center mb-4 `}>
          <ProductSearchInput
            value={searchTerm}

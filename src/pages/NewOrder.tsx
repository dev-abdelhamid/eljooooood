  ...
  return (
    <div className="mx-auto px-4 py-6 min-h-screen overflow-y-auto scrollbar-thin" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <div className={`space-y-3 ${orderItems.length > 0 ? 'lg:grid lg:grid-cols-3 lg:gap-6 lg:space-y-0' : ''}`}>
                    ...
                    <div className="mt-3 flex justify-end gap-1.5">
                      {cartItem ? (
                        <div className="flex items-center gap-1.5">
                          ...
                          <div className="w-7 h-7 text-center font-medium text-xs">{cartItem.quantity}</div>
                          <button
                            onClick={() => updateQuantity(product._id, cartItem.quantity + 1)}
        ...
        {orderItems.length > 0 && (
          <div className="lg:col-span-1 lg:sticky lg:top-8 space-y-3 max-h-[calc(100vh-2rem)] overflow-y-auto scrollbar-thin" ref={summaryRef}>
            <div className="p-4 bg-white rounded-xl shadow-sm">

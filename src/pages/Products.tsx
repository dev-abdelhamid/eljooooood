  ...
  const CustomInput = ({
    ...
    <div className="relative group w-full max-w-md">
      ...
      <input
        ...
        className="w-full pl-12 pr-10 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300 bg-white shadow-md hover:shadow-lg text-sm placeholder-gray-400"
  ...
  const CustomSelect = ({
    ...
    <div className="relative group w-full max-w-md">
      <select
        value={value}
        onChange={onChange}
        className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300 bg-white shadow-md hover:shadow-lg appearance-none text-sm text-gray-700 focus:bg-gray-50 cursor-pointer"
        aria-label={ariaLabel}
      >
        {children}
      </select>
    ...
    <div className="mx-auto px-4 py-6 min-h-screen overflow-y-auto scrollbar-thin" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="mb-6 flex flex-col items-center sm:flex-row sm:justify-between sm:items-center gap-4">
        ...
        {user?.role === 'admin' && (
          <button
            onClick={() => openModal()}
            className="w-full sm:w-auto px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-sm transition-colors flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
        ...
        {loading ? (
          ...
          <div className="p-8 text-center bg-white rounded-xl shadow-md">
            ...
            {user?.role === 'admin' && !searchTerm && !filterDepartment && (
              <button
                onClick={() => openModal()}
                className="mt-4 px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-sm transition-colors"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {products.map((product) => (
              <div
                key={product._id}
                className="p-5 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 flex flex-col justify-between"
              >
                ...
                {user?.role === 'admin' && (
                  <div className="mt-4 flex items-center justify-end gap-2">
                    <button
                      ...
                      className="p-2 w-8 h-8 bg-blue-500 hover:bg-blue-600 text-white rounded-full transition-colors flex items-center justify-center"
                    ...
                    <button
                      ...
                      className="p-2 w-8 h-8 bg-red-500 hover:bg-red-600 text-white rounded-full transition-colors flex items-center justify-center"
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl max-w-full w-[95vw] sm:w-[70vw] lg:w-[50vw] p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300 bg-white shadow-md hover:shadow-lg text-sm"
                  />
                </div>
                <div>
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-sm transition-colors"
